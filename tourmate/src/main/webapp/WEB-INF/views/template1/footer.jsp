...
<body class="homepage">
 ...
 <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2016 <a target="_blank" href="http://localhost:9090/spring_board/" title="COME TOur MatE">TOurMAte</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
                    	<li><img src="resources/corlate/images/logo/logo1.png" width="100px" height="30px"></li>
                        <li><a href="#">Home</a></li>
