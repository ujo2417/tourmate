   ...
   <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(/meresources/corlate/images/slider/background1.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">저와함께 여행을 떠나 보실까요?</h1>
                                    <h2 class="animation animated-item-2">인신매매 NO!NO!NO!. 저와 손잡고 떠나요~! TOGETHER!</h2>
