...
<body>
	...
	<table width="500" cellpadding="0" cellspacing="0" border="1">
			...
			<tr>
				<td width="50"> 번호 </td>
				<td> ${content_view.user_num} </td>
			</tr>
			<tr>
				<td > 히트 </td>
				<td> ${content_view.user_readcount} </td>
			</tr>
			<tr>
				<td > 이름 </td>
			...
			<tr>
				<td > 제목 </td>
				<td> ${content_view.user_title}</td>
			</tr>
			<tr>
				<td> 내용 </td>
				<td height = "200"> ${content_view.user_content}</td>
			</tr>
			<tr >
				<td colspan="2">
				<a href="adminUserlist">목록보기</a> &nbsp;&nbsp; 
				<a href="adminuserdelete?user_num=${content_view.user_num}">삭제</a> &nbsp;&nbsp; 
				
			</tr>
		</table>
		
		<!-- 댓글쓰기 -->
		<form name="replymodifyform" action="adminuserreplywrite" method="post"  onSubmit="return checkIt()">
		<input type="hidden" name="re_freenum" value="${content_view.user_num}" >
		...
		<form action="adminuserreplydelete" method="post">
		<tr>	
			<td>${re_dto.mem_id }
