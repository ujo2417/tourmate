...
public class ApiDto {
	...
	private String addr1,addr2,cat1,cat2,cat3,firstimage,firstimage2,mapx,
	mapy,title,zipcode, areacode,contentid,contenttypeid,createdtime,mlevel,modifiedtime,
	readcount,sigungucode
	
	//����,�Ұ�,�̹����� ���Ǵ� ����
	,booktour,homepage,overview,numOfRows,pageNo,totalCount,
	chkbabycarriage,chkcreditcard,chkpet,expguide,heritage1,heritage2,heritage3,infocenter,parking,restdate,
	fldgubun,infoname,infotext,serialnum,
